								...
								<div class="card-body p-8 text-center">
									...
									<div class="mb-md-5 mt-md-4 pb-5">
										...
										<h5>Renseignez votre Fiche frais :</h5>
											<center>
												<?php echo '<form action="'.base_url().'/public/index.php?action=envoie" method="post" class="form-connexion">'?>
											</center>	
											<center>
													...
													<div class="formulaires">
														<table>
																<p><strong><u>Frait forfaitaire :</u></strong></p>
																	<label for="etape">
																		Forfait étape:<input type="text" id="name" name="etape" minlength="1">
																	</label>
																	</br>
																	</br>
																	<label for="km">
																		Frais kilométrique :<input type="text" id="name" name="km" minlength="1">
																	</label>
																	</br>
																	</br>
																	<label for="nuit">
																		Nuitée hotel: <input type="text" id="name" name="nuit" minlength="1">
																	</label>
																	</br>
																	</br>
																	<label for="repasResto">
																		Repas restaurant: <input type="text" id="name" name="repasResto" minlength="1">
																	</label>
																	</br>
																	</br>
																<button class="btn btn-outline-danger btn-lg px-5" type="submit" name="a nommer" value="a nomme">valider</button> 
														</table>
													</div>
												</form>	
												<br/>
